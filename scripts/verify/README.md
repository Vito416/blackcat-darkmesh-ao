...
- `deps_check.lua` — validates Lua dependency availability (`luv` optional unless `DEPS_REQUIRE_LUV=1`).
...
lua scripts/verify/deps_check.lua
# enforce luv explicitly (CI/full runtime check)
DEPS_REQUIRE_LUV=1 lua scripts/verify/deps_check.lua
# optional
