...
- Subscriptions: subscription start/cancel emitters via `ao.shared.analytics.subscription_start/cancel` with metrics `ao_subscription_*`; churn still modeled via cancel events.
