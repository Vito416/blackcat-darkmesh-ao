...
local function route(msg)
  ...
  maybe_persist_state(mutating_actions[msg.Action] == true or refresh_state_mutated)
  return resp
end
...
local function handle_resolver_action(msg)
  ...
  -- Return structured response so AOS runtime can encode it in-process.
  return resp
end
...
local function emit_handler_error(code, message, meta)
  return codec.error(code, message, meta)
end
