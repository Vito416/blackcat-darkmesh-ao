...
local PID_JDWT = "pid_jdwt_00000000000000000000000000000000000"
local PID_VDDL = "pid_vddl_00000000000000000000000000000000000"
local PID_BLGATEWAY = "pid_blgateway_0000000000000000000000000000000"
local MODULE_SITE_V1 = "module_site_v1_000000000000000000000000000000"
local SCHEDULER_DARKMESH = "scheduler_darkmesh_0000000000000000000000000000"
...
local applied = apply_bundle("resolver-it-apply-1", "admin", {
...
local applied_fail_closed = apply_bundle("resolver-it-apply-2", "admin", {
  policyMode = "soft",
  failOpen = false,
  dnsProofState = {
    ["vddl.fun"] = {
